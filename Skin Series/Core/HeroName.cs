namespace Skin_Series.Core
{
    ...
    public static class HeroSkinName
    {
        public static List<HeroSkinNameEntity> HeroNameList => new List<HeroSkinNameEntity>
        {
            ...
            new HeroSkinNameEntity("Pharaoh Amumu", "憂傷法老"),
            new HeroSkinNameEntity("Vancouver Amumu", "溫哥華"),
            new HeroSkinNameEntity("Emumu", "情緒搖滾"),
            new HeroSkinNameEntity("Re-Gifted Amumu", "劣質禮品"),
            new HeroSkinNameEntity("Almost-Prom King Amumu", "差一點舞會國王"),
            new HeroSkinNameEntity("Little Knight Amumu", "悲劇騎士"),
            new HeroSkinNameEntity("Sad Robot Amumu", "哀傷機器人"),
            new HeroSkinNameEntity("Surprise Party Amumu", "派對木乃伊"),
            new HeroSkinNameEntity("Mercenary Katarina", "賞金刺客"),
            new HeroSkinNameEntity("Red Card Katarina", "紅牌 ! !"),
            new HeroSkinNameEntity("Bilgewater Katarina", "海賊魅影"),
            new HeroSkinNameEntity("Kitty Cat Katarina", "貓女"),
            new HeroSkinNameEntity("High Command Katarina", "諾克薩斯指揮官"),
            new HeroSkinNameEntity("Sandstorm Katarina", "沙漠風暴"),
            new HeroSkinNameEntity("Slay Belle Katarina", "金戈貝兒"),
            new HeroSkinNameEntity("Warring Kingdoms Katarina", "戰國武姬"),
            new HeroSkinNameEntity("PROJECT: Katarina", "菁英計畫"),
            new HeroSkinNameEntity("Charred Maokai", "熔岩炬木"),
            new HeroSkinNameEntity("Totemic Maokai", "圖騰樹人"),
            new HeroSkinNameEntity("Festive Maokai", "聖誕樹人"),
            new HeroSkinNameEntity("Haunted Maokai", "鬼影幢幢"),
            new HeroSkinNameEntity("Goalkeeper Maokai", "神樹守門員"),
            new HeroSkinNameEntity("Meowkai", "喵凱"),
            new HeroSkinNameEntity("Victorious Maokai", "戰爭英雄"),
            new HeroSkinNameEntity("Redeemed Riven", "破刃英豪"),
            new HeroSkinNameEntity("Crimson Elite Riven", "戰場貴族"),
            new HeroSkinNameEntity("Battle Bunny Riven", "戰鬥兔女郎"),
            new HeroSkinNameEntity("Championship Riven", "永恆榮耀"),
            new HeroSkinNameEntity("Dragonblade Riven", "巾幗女將"),
            new HeroSkinNameEntity("Arcade Riven", "電玩女神"),
            new HeroSkinNameEntity("Championship Riven 2016", "2016 永恆榮耀"),
            new HeroSkinNameEntity("Dawnbringer Riven", "黎明使者"),
            new HeroSkinNameEntity("Shockblade Zed", "衝擊利刃"),
            new HeroSkinNameEntity("SKT T1 Zed", "SKT T1"),
            new HeroSkinNameEntity("PROJECT: Zed", "菁英計畫"),
            new HeroSkinNameEntity("Championship Zed", "永恆榮耀"),
            new HeroSkinNameEntity("Cosmic Dawn Rakan", "星河黎羽"),
            new HeroSkinNameEntity("Gothic Orianna", "哥特魔偶"),
            new HeroSkinNameEntity("Sewn Chaos Orianna", "巫毒娃娃"),
            new HeroSkinNameEntity("Bladecraft Orianna", "刺客舞者"),
            new HeroSkinNameEntity("TPA Orianna", "中路野獸"),
