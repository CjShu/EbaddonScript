...
namespace ezEvade
{
    class EvadeSpell
    {
        ...
        private static Menu CreateEvadeSpellMenu(EvadeSpellData spell)
        {
            ...
            string menuName = spell.name.ToEzEvadeName() + " (" + spell.spellKey.ToString() + ") \u8a2d\u7f6e";

            if (spell.isItem)
            {
                menuName = spell.name + " \u8a2d\u7f6e";
            }

            Menu newSpellMenu = new Menu(menuName, spell.charName + spell.name + "EvadeSpellSettings");
            newSpellMenu.AddItem(new MenuItem(spell.name + "UseEvadeSpell", "\u4f7f\u7528\u6280\u80fd \u8eb2\u907f").SetValue(true));

            newSpellMenu.AddItem(new MenuItem(spell.name + "EvadeSpellDangerLevel", "\u5371\u96aa\u7b49\u7d1a")
            ...
            newSpellMenu.AddItem(new MenuItem(spell.name + "EvadeSpellMode", "\u6280\u80fd\u6a21\u5f0f")
                .SetValue(new StringList(new[] { "\u7121\u6cd5\u8eb2\u907f", "\u6fc0\u6d3b\u6642\u9593", "\u7e3d\u662f\u4f7f\u7528" },
