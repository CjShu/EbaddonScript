...
namespace ezEvade
{
    class AutoSetPing
    {
        ...
        public AutoSetPing(Menu mainMenu)
        {
            ...
            Menu autoSetPingMenu = new Menu("\u81ea\u52d5\u8a2d\u7f6e Ping", "AutoSetPingMenu");
            autoSetPingMenu.AddItem(new MenuItem("AutoSetPingOn", "\u81ea\u52d5\u8a2d\u5b9a Ping").SetValue(true));
            autoSetPingMenu.AddItem(new MenuItem("AutoSetPercentile", "\u81ea\u52d5 \u8a2d\u5b9a \u767e\u5206\u4f4d\u6578").SetValue(new Slider(75, 0, 100)));
